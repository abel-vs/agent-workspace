  ...
  return (
    <div className="flex max-h-[80vh] flex-col gap-4 overflow-hidden p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <DialogClose className="text-foreground">Close</DialogClose>
      </div>

      <div className="flex w-fit items-center gap-1 rounded-full border border-border bg-background p-1 text-xs">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-3">
              {providerUsage.length === 0 ? (
                <div className="rounded-2xl border border-border bg-background/70 p-6 text-center">
                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          {provider.plan ? (
                            <span className="rounded-full bg-card px-2 py-0.5 text-[10px] font-medium text-foreground">
                              {provider.plan}
                            </span>
                          ) : null}
                          {isDefault ? (
                          ...
                          <div className="mt-3 flex items-center justify-between gap-2">
                            ...
                            {!isDefault ? (
                              <button
                                ...
                                className="rounded-lg border border-border bg-background px-3 py-1.5 text-xs font-medium text-foreground transition hover:bg-card"
                              >
                                Set as Default
                              </button>
                            ) : null}
