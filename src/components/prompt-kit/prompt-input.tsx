...
function PromptInputTextarea({
  ...
  return (
    <textarea
      ...
      onPointerDown={handlePointerDown}
      className={cn(
        'text-foreground min-h-[28px] w-full resize-none border-none bg-transparent shadow-none outline-none focus-visible:ring-0 pl-4 pr-1 py-2 md:py-0 text-base placeholder:text-muted-foreground',
        className,
      )}
      rows={1}
      enterKeyHint="send"
