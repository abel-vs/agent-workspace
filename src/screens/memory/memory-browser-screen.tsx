  ...
  return (
    ...
    >
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 p-3 md:grid-cols-3 md:p-4">
        <aside className="flex min-h-0 flex-col rounded-2xl border border-border bg-background dark:border-neutral-800 dark:bg-neutral-950 md:col-span-1">
          <button
            type="button"
          ...
          >
            ...
            <span className="md:hidden text-muted-foreground dark:text-neutral-400">
              <HugeiconsIcon
          ...
          {searchEnabled ? (
            <div className="min-h-0 flex-1 overflow-y-auto px-2 pb-2">
              ...
              <div className="space-y-1">
                {searchQuery.isLoading ? (
                  <div className="rounded-lg border border-border bg-background/80 px-3 py-2 text-xs text-muted-foreground dark:border-neutral-800 dark:bg-neutral-900/60 dark:text-neutral-500">
                    Searching...
                  </div>
                  ...
                  searchResults.map((result, index) => (
                    ...
                    >
                      ...
                      <div className="mt-0.5 line-clamp-2 text-xs text-foreground dark:text-neutral-200">
            ...
            >
              <div className="max-h-72 space-y-1 overflow-y-auto pr-1 md:h-full md:max-h-none">
                ...
                <div className="px-1 pt-2 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground dark:text-neutral-500">
                  memory/ or memories/
                </div>
        ...
        <section className="min-h-0 rounded-2xl border border-border bg-background dark:border-neutral-800 dark:bg-neutral-950 md:col-span-2">
          <div className="flex items-center justify-between border-b border-border px-3 py-2 dark:border-neutral-800">
            <div className="min-w-0">
              <div className="truncate font-mono text-sm text-foreground dark:text-neutral-100">
                ...
                {isEditing ? (
                  <>
                    ...
                    <button
                      ...
                      className="rounded-md border border-border px-3 py-1.5 text-xs font-semibold transition-colors hover:border-border hover:bg-muted disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:border-neutral-600 dark:hover:bg-neutral-800"
                    >
                      Cancel
                    </button>
                    {hasUnsavedChanges ? (
                  ...
                  <button
                    ...
                    className="relative inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-1.5 text-xs font-semibold transition-colors hover:border-border hover:bg-muted dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:border-neutral-600 dark:hover:bg-neutral-800"
                  >
                    <HugeiconsIcon
                  ...
                  {lines.map((line, index) => {
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          'grid grid-cols-[56px_1fr] gap-0 border-b border-border/80 last:border-b-0 dark:border-neutral-900/80',
                          highlighted && 'bg-yellow-300/10',
                        )}
                      >
                        <div
                          className={cn(
                            'select-none border-r border-border px-2 py-0.5 text-right text-muted-foreground dark:border-neutral-800 dark:text-neutral-600',
                            highlighted && 'text-yellow-200',
                          )}
                        >
                          {lineNumber}
                        </div>
                        <pre className="overflow-x-auto whitespace-pre-wrap break-words px-3 py-0.5 text-foreground dark:text-neutral-200">
                          {line || ' '}
                        </pre>
                      </div>
                    )
...
function FileRow({
  ...
  return (
    ...
    >
      <div className="truncate font-mono text-xs text-foreground dark:text-neutral-100">
        {file.path}
      </div>
      <div className="mt-0.5 text-[11px] text-muted-foreground dark:text-neutral-500">
