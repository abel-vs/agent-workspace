...
export function AgentsScreen() {
  ...
  return (
    <main className="min-h-full bg-background px-4 pb-24 pt-5 text-foreground md:px-6 md:pt-8">
      <section className="mx-auto w-full max-w-[1480px] space-y-5">
        <header className="flex flex-col gap-4 rounded-xl border border-border bg-background/80 px-5 py-4 shadow-sm md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            />
            <Button
              className="bg-accent-500 text-foreground hover:bg-accent-400"
        ...
        <section className="rounded-xl border border-border bg-[var(--theme-card)] p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-foreground">Screen simplified</h2>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <Button
              variant="secondary"
              className="border border-border bg-[var(--theme-card)] text-foreground hover:bg-background"
              onClick={() => void navigate({ to: '/conductor' })}
            >
              Open Conductor
            </Button>
